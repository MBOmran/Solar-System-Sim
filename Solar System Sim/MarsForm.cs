    ...
    public partial class MarsForm : Form
    {
        ...
        private void MarsForm_Load(object sender, EventArgs e)
        {
            Form1.htmlContent = @"
                ...
                <head></head>
                <body>
                    <iframe src='https://eyes.nasa.gov/apps/solar-system/#/mars?rate=440&embed=true' width='100%' height='100%'></iframe>
                </body>
                </html>";
        ...
        {
            System.Diagnostics.Process.Start("https://science.nasa.gov/mars/");
        }

        private void button2_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("https://en.wikipedia.org/wiki/Mars");
